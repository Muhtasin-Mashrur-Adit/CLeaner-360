      ...
      <div class="col-md-5 col-lg-4 order-md-last">
        ...
        <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              <h6 class="my-0">Subscribe for one month</h6>
        ...
        <form class="needs-validation" novalidate >
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" id="address" placeholder="Bashundhra R/A, Block D , Road 6, plat 213, floor 2A" required>
              <div class="invalid-feedback">
                Please enter your address your billing address is you garbage pick up address.
              </div>
            </div>
